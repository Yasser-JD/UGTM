        ...
        <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md border border-gray-100">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
                ...
                <div style="margin-bottom:0.5rem;" class="flex items-center">
                    <input type="checkbox" name="remember" id="remember"
                        class="h-4 w-4 text-ugtm-purple focus:ring-ugtm-purple border-gray-300 rounded">
                ...
                <button type="submit"
                    class="w-full bg-ugtm-purple text-white font-bold py-3 rounded-lg hover:bg-ugtm-purple-dark transition shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                    دخول
                </button>
            </form>
            ...
            <div class="mt-6 text-center text-sm text-gray-600">
                ليس لديك حساب؟ <a href="{{ route('register') }}"
                    class="text-ugtm-purple font-bold hover:underline">انخرط الآن</a>
            </div>
        </div>
    </div>
</x-layout>