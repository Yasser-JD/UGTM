        ...
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                <div class="p-8">
                    @if(session('success'))
                        <div
                            class="bg-green-50 text-green-700 p-4 rounded-lg mb-6 flex items-center gap-3 border border-green-100">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div>
                            @if($user->is_active)
                                <span
                                    class="bg-ugtm-purple text-white px-4 py-2 rounded-full font-bold shadow-sm">منخرط</span>
                            @else
                                <span
                                    class="bg-yellow-100 text-yellow-800 px-3 py-1 md:px-4 md:py-2 text-sm md:text-base rounded-full font-bold border border-yellow-200">في
                                    انتظار التفعيل</span>
                            @endif
                        </div>
                    </div>
                    ...
                    @if(!$user->is_active)
                        <div class="mt-8 bg-blue-50 p-4 rounded-xl border border-blue-100 text-blue-800">
                            <p class="flex items-center gap-2">
                                ...
                                طلب عضويتك قيد المراجعة من قبل الإدارة. سيتم تفعيل حسابك قريباً لتتمكن من تحميل الوثائق
                    ...
                    @else
                        <div class="mt-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div
                                    class="bg-gray-50 p-4 rounded-xl border border-gray-200 text-center hover:shadow-md transition cursor-pointer">
                                    <svg class="w-8 h-8 text-ugtm-purple mx-auto mb-2" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <a href="{{ route('complaints.create') }}"
                                    class="bg-gray-50 p-4 rounded-xl border border-gray-200 text-center hover:shadow-md transition cursor-pointer group">
                                    <svg class="w-8 h-8 text-ugtm-purple mx-auto mb-2 group-hover:scale-110 transition"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z">
                                        </path>
                                    </svg>
                                    <span class="font-bold text-gray-700">بطاقة عرض مشكل</span>
                                </a>
                    ...
                    <div class="mt-8 border-t border-gray-100 pt-6 text-left">
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit"
                                class="bg-red-50 text-red-600 hover:bg-red-600 hover:text-white px-6 py-3 rounded-xl font-bold transition duration-300 flex items-center gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
