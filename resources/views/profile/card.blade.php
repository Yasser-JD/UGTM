<x-layout title="بطاقة العضوية">
    <style>
        @media print {
            ...
            #printable-card p.text-gray-500 {
            ...
            #printable-card .text-sm {
                font-size: 7pt !important;
            }

            #printable-card .text-xs {
            ...
            #printable-card .text-[10px] {
                display: none !important;
            }

            /* Hide "Scan to verify" text */

            /* Hide footer */
            #printable-card .border-t {
                display: none !important;
            }
        ...
        <div class="container mx-auto px-4 w-full md:w-[80%] md:max-w-none">
            ...
            <div class="mb-6 flex justify-between items-center no-print">
                <a href="{{ route('profile.show') }}"
                    class="flex items-center gap-2 text-gray-500 hover:text-ugtm-purple transition">
                ...
                <button onclick="window.print()"
                    class="flex items-center gap-2 bg-ugtm-purple text-white px-4 py-2 rounded-lg hover:bg-navy-900 transition shadow-sm">
            ...
            <div id="printable-card"
                class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200 relative">
                <!-- Header Pattern -->
                ...
                <div class="px-8 pb-8 text-center -mt-12 relative z-10">
                    <div
                        class="w-24 h-24 bg-white p-2 rounded-full shadow-lg mx-auto mb-4 flex items-center justify-center border-4 border-white">
                    ...
                    <div class="print-content-grid">
                        <div class="space-y-3 text-right text-sm">
                            ...
                            <div class="flex justify-between items-center pb-2">
                                ...
                                <span
                                    class="bg-green-100 text-green-700 px-2 py-0.5 rounded text-xs font-bold">منخرط</span>
                            </div>
                        </div>

                        <!-- QR Code -->
                        <div
                            class="mt-6 bg-gray-50 p-3 rounded-xl border border-gray-100 flex flex-col items-center justify-center">
                ...
                <div class="bg-gray-50 p-3 text-center border-t border-gray-100">
                    <p class="text-[10px] text-gray-400">الجامعة الحرة للتعليم - FAE</p>
                </div>
            </div>
